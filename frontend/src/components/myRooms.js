...
const IAmAParty = (evt) => {
        ...
        axios.post(process.env.BASE_URL+":8000/api/i_am_party/", {
                jwt: jwt['jwt'],
                number: evt,
                duration: duration,
          })
...
const EnterSwapCode = (evt) => {
        ...
        //axios.post(process.env.REACT_APP_DJANGO_IP+":8000/api/rooms/", {
        axios.post(process.env.BASE_URL+":8000/api/swap_it_up/", {
                jwt: jwt['jwt'],
                number: evt,
                swap_code: code
          })
...
export default class MyRoomsTable extends React.Component {
  ...
  componentDidMount() {
    ...
    //axios.post(process.env.REACT_APP_DJANGO_IP+":8000/api/rooms/", {
    axios.post(process.env.BASE_URL+":8000/api/my_rooms/", {
            jwt: jwt["jwt"]
      })
      .then(res => {
        //console.log(res.data);
